...
func DefaultConfig() *viper.Viper {
	...
	c.SetDefault("Core.Connection.Check.Seconds", 30*time.Second)
	c.SetDefault("Core.Connection.Check.Destination", "google.co.uk")
	c.SetDefault("Core.DebugMessageInterval", time.Minute)
	...
	c.SetDefault("Device.ExpectedCards", 1)
	...
	c.SetDefault("Profit.Calc.Conceal", 1.1)
	c.SetDefault("Profit.Calc.v4", 0.95)
	c.SetDefault("Profit.Calc.Heavy", 1.8)
	c.SetDefault("Profit.Calc.HeavyX", 1.8)
	c.SetDefault("Profit.Calc.Haven", 2.5)
	c.SetDefault("Profit.Calc.Saber", 1.1)
	c.SetDefault("Profit.Calc.Litev1", 0.95)
